...
private:
    ...
    const double EPSILON_MIN = 0.01;     // Valor mínimo de epsilon
	bool exploitation_mode = false; // Si es TRUE, epsilon se fija a 0.0 (explota)
    ...
    const int PODA_WINDOW_SIZE = 20; // Tamaño de la ventana
